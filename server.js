...
const postgres = knex({
	...
	connection: {
		connectionString: process.env.DATABASE_URL, // this = local host (then changed to heroku's address)
		ssl: true,
	},
});
...
app.listen(process.env.PORT || 3001, () => {
	console.log(`app is running on port ${process.env.PORT}`); // bash command -> "PORT=3001 node server.js"
});
// console.log(PORT);
